...
public class Class8_StructInterface : MonoBehaviour
{
    ...
    // 類別：參考型別 - 傳址
    public Class_Data c2 = new Class_Data("50", 999, 100);
    public Class_Data c3 = new Class_Data("亮", 9999, 50);

    // 結構：實值型別 - 傳值
    public Struct_Data s2 = new Struct_Data("50", 999, 100);
    public Struct_Data s3 = new Struct_Data("亮", 9999, 50);
